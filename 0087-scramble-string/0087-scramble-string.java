// leetcode daily challenge - 30th march

class Solution {
    // for storing already solved problem
    ...
    public boolean isScramble(String s1, String s2) {
        ...
        // this shows that -> size of both string equal
        // strings not equal
        // so if size is equal(where size == 1) they are not equal then false
        if(n==1)  return false;
